...
describe Dessert do
  ...
  let(:bad_dessert) { Dessert.new("muffin", "hi", chef) }
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect { cake.eat(70) }.to raise_error("not enough left!")
    end
  end

  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("The fabulous Nick")
      expect(cake.serve).to eq("The fabulous Nick has made 50 cakes!")
    end
